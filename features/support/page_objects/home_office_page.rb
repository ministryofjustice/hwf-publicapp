class HomeOfficePage < BasePage
  ...
  section :content, '#content' do
    ...
    element :hint, 'p', text: 'For example, L1234567 or L1234567/1 (for family members)'
    ...
    element :error_link, '.error-link', text: 'Enter your Home Office reference number'
    element :error_message, '.govuk-error-message', text: 'Enter your Home Office reference number'
  end
